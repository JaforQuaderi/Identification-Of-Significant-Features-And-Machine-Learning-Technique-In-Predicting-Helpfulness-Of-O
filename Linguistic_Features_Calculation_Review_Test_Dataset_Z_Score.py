...
for rvw in review:
    ...
    print("-------------------")
    print("ADJ SV SAV IAV DAV")
    print("", review_adjective_count, "", review_state_verb_count, " ", review_state_action_verb_count, " ",
          review_imperative_action_verb_count, " ", review_descriptive_action_verb_count)
...
print(state_verb_mean)
print(state_action_verb_mean)
print(imperative_action_verb_mean)
print(descriptive_action_verb_mean)
...
print(state_verb_stdv)
print(state_action_verb_stdv)
print(imperative_action_verb_stdv)
print(descriptive_action_verb_stdv)
...
print(state_verb_z_score)
print(state_action_verb_z_score)
print(imperative_action_verb_z_score)
print(descriptive_action_verb_z_score)